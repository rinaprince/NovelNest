 ...
 */
final class Version20250521145803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, telef VARCHAR(50) NOT NULL, direccio VARCHAR(255) NOT NULL, num_tarj VARCHAR(255) NOT NULL, pseudonim VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_C74404557C96A3C1 (pseudonim), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE factura (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, tipus VARCHAR(255) NOT NULL, num_factura VARCHAR(255) NOT NULL, preu NUMERIC(10, 2) NOT NULL, quantitat INT NOT NULL, INDEX IDX_F9EBA00919EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE obra (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, url_arxiu_id INT NOT NULL, factura_id INT DEFAULT NULL, tipus VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, num_obra_seguiment INT NOT NULL, estat TINYINT(1) NOT NULL, portada VARCHAR(255) NOT NULL, INDEX IDX_2EEE6DBD19EB6921 (client_id), INDEX IDX_2EEE6DBDD64606DB (url_arxiu_id), INDEX IDX_2EEE6DBDF04F795F (factura_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom_usuari VARCHAR(50) NOT NULL, contrasenya VARCHAR(255) NOT NULL, nom VARCHAR(50) NOT NULL, cognom VARCHAR(50) NOT NULL, correu VARCHAR(50) NOT NULL, rols JSON NOT NULL COMMENT \'(DC2Type:json)\', rol VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
