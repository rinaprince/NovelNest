...
class AutopublicacioController extends AbstractController
{
    ...
    public function index(
        ...
        if ($request->isMethod('POST')) {
            if (!$showForm) {
                // Usuario no autenticado intentando enviar formulario
                $accessDenied = true;
                $mensaje = 'No tienes permiso para ver este formulario. Debes iniciar sesión como cliente.';
            } else {
                // Procesar el formulario solo si tiene permisos
                ...
                // Resto de validaciones y procesamiento...
                if (!$pdfFile) {
